...
function CareerDetails({ fetchCareersById }) {
	// Call the scrollToTop function when needed
	scrollToTop();

	const { id } = useParams();

	const { data, error, status, isLoading } = useQuery(['career', id], () =>
		fetchCareersById(id)
	);
				...
				<main>
					{isLoading ? (
						...
						<section>
							<h2>{data.title}</h2>
							<p>
								Starting salary: <strong>${data.salary}</strong>
							</p>
							<p>Location: {data.location}</p>
							<div className='details'>
								<h3>Description: </h3>
								<p>
									{data.description} Proident voluptate occaecat irure aliqua
									proident elit esse qui nisi deserunt. Id consequat qui
									occaecat aliqua dolor exercitation amet sint ullamco sit
									eiusmod officia sit laboris. Excepteur irure laborum deserunt
									enim labore eiusmod. Aliquip aliquip minim sunt quis nulla
									officia ipsum.
								</p>
								...
								<p>
									Dolore fugiat qui sunt elit officia magna elit exercitation
									quis eiusmod dolor et non. Quis sunt aute tempor pariatur
									nulla non ea non proident. Minim commodo adipisicing ea anim
									occaecat sunt laboris culpa sunt tempor. Commodo officia
									proident sunt nostrud minim id.
								</p>

								<h3>
									Nostrud amet sunt labore mollit anim sunt. Dolore excepteur
									consectetur laboris cupidatat excepteur ea laboris. Ad
									occaecat dolore laboris eiusmod occaecat. Velit enim cupidatat
									dolore tempor minim elit eiusmod?
								</h3>
								<p>
									Irure commodo magna non ut. Mollit velit minim ut id quis
									nulla aliqua qui esse dolore esse aliqua veniam non. Enim ex
									magna in aliquip dolor incididunt ea officia sit. Cupidatat
									sint sunt labore labore esse enim ullamco enim amet do. Dolor
									Lorem excepteur officia amet ex veniam non non irure tempor
									mollit eu officia.
								</p>

								<p>
									Id est pariatur occaecat occaecat excepteur aliqua Lorem
									nostrud consectetur ad. Amet ullamco consequat id pariatur
									exercitation ut do elit ullamco nulla dolore exercitation.
									Occaecat deserunt cillum esse do nisi commodo consectetur.
									Proident sit eiusmod irure voluptate deserunt in est.
									Consequat sunt veniam est culpa cillum anim. Occaecat irure
									ullamco minim velit tempor adipisicing enim esse in.
								</p>
							</div>
						</section>
					)}
